	          ...
	          <div class="row">
	            <div class="col-lg-6 col-7">
					...
					<p class="text-sm mb-0">
		                Table yang berisi list table yang digunakan oleh aplikasi
		            </p>
	            ...
	            <table class="table align-items-center mb-0">
	              <thead>
	                <tr>
	                  ...
	                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Table</th>
	                </tr>
	              </thead>
	              <tbody>
	              	...
	              	@foreach ($params as $param)
				        <tr>
							...
							<td>
			                    <div class="d-flex flex-column justify-content-center">
			                     	<span class="text-xs font-weight-bold">{{ $param->TABLE_NAME }}</span>
				                </div>
			                </td>
						</tr>
				    @endforeach
