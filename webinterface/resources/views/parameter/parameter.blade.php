	          ...
	          <div class="row">
	            <div class="col-lg-6 col-7">
					...
					<p class="text-sm mb-0">
		                Table parameter yang digunakan oleh aplikasi
		            </p>
				        	...
				        	<td>
			                    <div class="d-flex px-2 py-1">
				                    <div class="d-flex flex-column justify-content-center">
				                    	<h6 class="mb-0 text-sm">{{ $param->PARAM_ID1 }}</h6>
				                    </div>
			                    </div>
			                </td>
							<td>
			                    <div class="align-middle text-center text-sm">
			                     	<span class="text-xs font-weight-bold">{{ $param->PARAM_ID2 }}</span>
				                </div>
			                </td>
							<td>
			                    <div class="align-middle text-center text-sm">
				                   	<span class="text-xs font-weight-bold">{{ $param->VARCHAR_1 }}</span>
			                    </div>
			                </td>
							<td>
								<div class="align-middle text-center text-sm">
			                     	<span class="text-xs font-weight-bold">{{ $param->VARCHAR_2 }}</span>
				                </div>
			                </td>
						</tr>
				    @endforeach
